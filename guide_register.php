...
<!--------------------------------------------------------------------------------------------------------------------------------------->
        ...
        <div class="container">
          ...
          <form class="rd-form rd-form-variant-2 rd-mailform" data-form-output="form-output-global" data-form-type="contact" method="post" action="bat/rd-mailform.php">
            <div class="row row-14 gutters-14">
              ...
              <div class="col-md-4">
                <div class="form-wrap">
                  <input class="form-input" type="text" id="nid_no" name="nid_no" data-constraints="@Email @Required">
      ...
      <form action="guide_insert_db.php" method="post" enctype="multipart/form-data" id="box2">
        ...
        <input class="text" type="text" id="nid_no" name="nid_no" placeholder="ex: 412*********" size="40px">
        <br><br>
        ...
        <input class="text" type="text" id="contact_no" name="contact_no" placeholder="ex: 01*********" size="40px">
        <br><br>
        <label for="email">Email</label>:
        <input class="text" type="text" id="email" name="email" placeholder="ex: employee@gmail.com" size="40px">
        <br><br>
        <label for="addrees">Address</label>:
        <input class="text" type="text" id="address" name="address" placeholder="ex: 2nd Floor, House 108" size="40px">
        <br><br>
        <label for="bank_acc">Bank Account</label>:
        <input class="text" type="text" id="bank_acc" name="bank_acc" placeholder="ex: " size="40px">
        <br><br>
        <label for="pv_Image">Police Varification</label>:
        <br><br>
        <input type="file" id="pv_Image" name="pv_Image">
        <br><br><br>
