...
$searchErr = '';
$curreny_shop_details = '';

if (isset($_POST['save'])) {
    if (!empty($_POST['search'])) {
        $search = $_POST['search'];
        $stmt = $con->prepare("select * from currency_shop where city like '%$search%' or district like '%$search%'");
        $stmt->execute();
        $curreny_shop_details = $stmt->fetchAll(PDO::FETCH_ASSOC);
    }
}
...
<html class="wide wow-animation" lang="en">
  <head>
  <title>Currency Exchange Shops</title>
...
<!-- Code here-->
<div class="container">
        <h3><u>Currency Exchange Shops</u></h3>
        <br /><br />
        <form class="form-horizontal" action="#" method="post">
            <div class="row">
                <div class="form-group">
                    <label class="control-label col-sm-4" for="email"><b>Search currency Shops</b>:</label>
                    <div class="col-sm-4">
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                    <?php
                    if (!$curreny_shop_details) {
                        echo '<tr>No data found</tr>';
                    } else {
                        foreach ($curreny_shop_details as $key => $value) {
                    ?>
                            <tr>
