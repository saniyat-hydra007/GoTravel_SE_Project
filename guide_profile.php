    ...
    if(isset($_GET['guide_id']) && !empty($_GET['guide_id'])){
        ...
        <!--------------------------------------------------------------------------------------------------------------------------------------->
              ...
              <?php
                ...
                $returnobj= mysqli_query( $connect, "SELECT * FROM guide AS g JOIN area AS a ON g.Area_ID = a.Area_ID JOIN city AS c ON a.City_ID = c.City_ID WHERE guide_id = '$guide_id'" )
                  or die("Can not execute query");
                    ...
                    while( $rows = mysqli_fetch_array( $returnobj ) ) {
                      ...
                      <section class="section section-sm bg-default">
                        <div class="container">
                          <h3 class="oh-desktop"><span class="d-inline-block wow slideInDown">Guide Profile</span></h3>
                          <div class="row row-sm row-40 row-md-50">
                            <div class="col-sm-6 col-md-12 wow fadeInRight">
                              <!-- Product Big-->
                              <article class="product-big">
                                <div class="unit flex-column flex-md-row align-items-md-stretch">
                                  <div class="unit-left"><a class="product-big-figure" href="#"><img src="<?php echo $Image?>" alt="" width="600" height="366"/></a></div>
                                  <div class="unit-body">
                                    <div class="product-big-body">
                                      <h5 class="product-big-title"><a href="#"><?php echo $Name;?></a></h5>
                                      ...
                                      <!-- <p class="product-big-text">Mobile        : 0<?php echo $Contact_no ?></p>
                                      <p class="product-big-text">email         : <?php echo $Email ?></p>
                                      <p class="product-big-text">Joining Date  : <?php echo $Joining_Date ?></p>
                                      <p class="product-big-text">Bio...</p>
                                      <p class="product-big-text">Bio...</p> -->
                                      <p class="product-big-text">Bio...</p>
                                      <?php
                                      if($access == 'admin'){
                                        if($Approved  == 2){
                                          ?>
                                          <input type="button" class="button button-black-outline button-ujarak" value="UNBLOCK" onclick="blockGuide('<?php echo $guide_id ?>');">
                                          <?php
                                        }
                                        else{
                                          ?>
                                          <input type="button" class="button button-black-outline button-ujarak" value="BLOCK" onclick="blockGuide('<?php echo $guide_id ?>');">
                                          <?php
                                        }
                                        ?>
                                        <input type="button" class="button button-black-outline button-ujarak" value="UPDATE" onclick="update_data('<?php echo $guide_id ?>');">
                                        <input type="button" class="button button-black-outline button-ujarak" value="DELETE" onclick="deleteProfile('<?php echo $guide_id ?>');">
                                      <?php
                                      }
                                      else{
                                      ?>
                                        <input type="button" class="button button-black-outline button-ujarak" value="BOOK" onclick="book();">
                                        <?php
                                      }
                                      ?>
                                        <input type="button" class="button button-black-outline button-ujarak" value="BACK" onclick="back();">

                                      <div class="product-big-price-wrap"><span class="product-big-price">500 BDT/h</span></div>
                                    </div>
                                  </div>
                                </div>
                              </article>
        ...
        <!--------------------------------------------------------------------------------------------------------------------------------------->
            ...
            function update_data(guide_id){
              location.assign('guide_profile_update.php?guide_id='+guide_id);
            }
            function back(){
