    ...
    <div class="row">
        <div class="col-xs-12 col-md-4">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="#"><span class="badge pull-right"><span class="glyphicon glyphicon-bdt"></span><?php echo $bill; ?>৳</span> Half Payment</a>
                </li>
            </ul>
            <br/>
            <input class="btn btn-success btn-lg btn-block" type="button" value="Pay " onclick="payment()" />
        </div>
    </div>
</div>
<br>
    ...
    <script>
      ...
      var check_outs="<?php echo $check_outs; ?>";
          ...
          var cardNumber = document.getElementById("cardNumber").value;
                ...
                if(count==0)
                location.assign('booking_server.php?name='+name+'&bill='+bill+'&city='
                +city+'&adult='+adult+'&children='+children+
