...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    ...
    <div class="page">
      ...
      ?>
      <section>
      <form id="box2" action="car_owner_approve_action_db.php" method="POST">
        <div style="font-size: 20px;margin: 10px;"><b>Set Data </b></div>
        <label for="owner_id"><b>Owner ID</b></label>:
        <input class="text" type="text" id="owner_id" name="owner_id" value="<?php echo $owner_id;?>">
        <br>
        ...
        <br>
        <br>
        <input class="button button-md button-default-outline-2 button-ujarak" type="submit" value="Set">
