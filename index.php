                ...
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    if(isset($_SESSION['username']) && !empty($_SESSION['username']))
                    {
                      ...
                      if($access  == 'admin'){
                        ?>
                        <li class="rd-nav-item"><a class="rd-nav-link" href="review_application_guide.php">Guide Requests</a></li>
                        <li class="rd-nav-item"><a class="rd-nav-link" href="city_register.php">Add City</a></li>
                        <li class="rd-nav-item"><a class="rd-nav-link" href="area_register.php">Add Area</a></li>
                        <li class="rd-nav-item"><a class="rd-nav-link" href="guide_register.php">Add Guide</a>
                        </li>
                        <?php
                      }

                      ?>
                      <li class="rd-nav-item"><a class="rd-nav-link" href="guide_list.php">Guide List</a></li>
                      <?php
                    }
                    else
                    {
                      ?>
                      <li class="rd-nav-item"><a class="rd-nav-link" href="work_with_us.php">Work with Us</a></li>
                      <?php
                    }
                    ?>
                    </li>
