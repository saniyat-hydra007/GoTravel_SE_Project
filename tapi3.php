...
$queryw = "UPDATE `train_seat` SET pay='paid' WHERE  `userr`='sooha' and `pass`=123 and l_id=$l_id ";
$query_run = (mysqli_query($link, $queryw));

$query1 = "SELECT pay FROM `train_seat`  WHERE l_id=$l_id and `userr`='sooha' and pay='paid'";
