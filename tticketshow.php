...
visibility: hidden;
    ...
    <body>
        ...
        $sql = "INSERT INTO `train_ticket`(`fromm`, `too`, `journey_date`, `return_date`, `passenger`, `class`, `trip_type`, `ticket_type`) VALUES ('$where','$destination','$sdate','$rdate','$person','$class','$triptype','$ttype')";
        ?>
        <h2>Ticket</h2>
        <?php
        ...
        ?>
          <script>
            ...
            location.assign("tticketbook.php");
          </script>
        <?php
        }
        if ($rdate == null) {
        ...
        <?php
          ...
          $sql1 =  "SELECT * FROM train WHERE  journey_date='$sdate' and base like '$where'  and '$person' <= available_st  and dest like '$destination' ";
        }  else if ($ttype == "any") {
          $sql1 =  "SELECT * FROM train WHERE  journey_date='$sdate' and class like '$class' and  base like '$where'  and '$person' <= available_st  and dest like '$destination' ";
        } else if ($class == "any") {
          $sql1 =  "SELECT * FROM train WHERE ticket_type Like '$ttype' and journey_date='$sdate'  and base like '$where'  and '$person' <= available_st  and dest like '$destination' ";
        }
         else {
          $sql1 =  "SELECT * FROM train WHERE ticket_type Like '$ttype' and journey_date='$sdate' and class like '$class' and base like '$where'  and '$person' <= available_st  and dest like '$destination' ";
        }
          ...
          <div>
            <table class="table">
              ...
              <tbody>
                ...
                ?>
                  <form action="taction.php" method="post">
        ...
        ?>
          ...
          $sql3 = "INSERT INTO `train_ticket`(`fromm`, `too`, `journey_date`, `return_date`, `passenger`, `class`, `trip_type`, `ticket_type`) VALUES ('$destination','$where','$rdate','0000-00-00','$person','$class','oneway','$ttype')";

          if ($ttype == "any"  && $class == "any") {
            $sql2 =  "SELECT * FROM train WHERE  journey_date='$rdate' and base like '$destination'  and '$person' <= available_st  and dest like '$where'order by fare desc ";
          }  else if ($ttype == "any") {
            $sql2 =  "SELECT * FROM train WHERE journey_date='$rdate' and class like '$class'  and base like '$destination'  and '$person' <= available_st  and dest like '$where' order by fare desc";
          } else if ($class == "any") {
            $sql2 =  "SELECT * FROM train WHERE ticket_type Like '$ttype' and journey_date='$rdate'   and base like '$destination'  and '$person' <= available_st  and dest like '$where' order by fare desc";
          } else {
            $sql2 =  "SELECT * FROM train WHERE ticket_type Like '$ttype' and journey_date='$rdate' and class like '$class'  and base like '$destination'  and '$person' <= available_st  and dest like '$where' order by fare desc";
          }
      ...
      <script>
        function show2() {
          ...
          location.assign('taction.php?nam='+nam +'&seat='+seat+'&base='+base+'&dest='+dest+'&journey_date='+journey_date +'&ticket_type='+ticket_type+'&ticket_cancellation_fee='+ticket_cancellation_fee+'&classs='+classs+'&slocation='+slocation+'&elocation='+elocation+'&person='+person+'&fare='+fare+'&journey_hour='+journey_hour+'&l_id='+l_id+'&rdate='+rdate+'&trip='+trip);
