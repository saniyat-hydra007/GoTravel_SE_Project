...
#b1{
  ...
  label{
    ...
    <section id="slideshow">
      <img id="slide" src="images/4.jpg" alt="Background Img">
      <div class="form">
        <form class=""  method="post" action="tticketshow.php">
        ...
        <label for="triptype">Trip type</label>
          ...
          <label for="pick">From Where</label>
          ...
          <option value="sayeedpur">sayeedpur</option>
          <option value="sylhet">sylhet</option>
          </select>
      
          <label for="destination">To Where</label>
          ...
          <label for="person">Passenger</label>
          <input type="text" id="person" name="person" placeholder="1" >
          ...
          <label for="sdate">Journey Date</label>
          ...
          <button type="submit" id="b1" name="a" >Search for the cheapest price <br><i class="fa fa-search"></i></button> 
