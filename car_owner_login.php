...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    ...
    <div class="page">
      ...
      <section>
      <form id="box2" action="car_owner_loginprocess.php" method="POST">
        <div style="font-size: 20px;margin: 10px;"><b>LOGIN AS CAR OWNER</b></div>
        ...
        <br>
        <br>
        <input class="button button-md button-default-outline-2 button-ujarak" type="submit" value="Log In">
        <button class="button button-md button-default-outline-2 button-ujarak" type="button" onclick="back()">Back</button>
      </form>

      <form id="box2" action="car_owner_register.php" method="POST">
