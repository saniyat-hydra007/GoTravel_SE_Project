...
$query = "UPDATE `train_seat` SET `availability`='n' WHERE id=$seat";
$query_run = (mysqli_query($link, $query));

$queryw = "UPDATE `train_seat` SET `userr`='sooha',`pass`=123  WHERE id=$seat";
$query_run = (mysqli_query($link, $queryw));

$query1 = "SELECT availability,n,id FROM `train_seat` WHERE id=$seat";
