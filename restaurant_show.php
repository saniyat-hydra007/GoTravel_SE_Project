...
<h2>Restaurants</h2>
<?php
    $sql1=  "SELECT * FROM restaurants WHERE Thana='$where' && District='$destination'";
...
if($query_run-> num_rows > 0){
  ...
  <table class="table">
       ...
       while($result=mysqli_fetch_array($query_run)){
           ?>
           <td class="row-data1"><img src="<?php echo $result['picture'] ?>" width="200" height="100"?> </td>
           <td class="row-data1"> <?php echo $result['Name'] ?> </td>
           <td class="row-data1"><a href="<?php echo $result['Link'] ?>"><?php echo $result['Name'] ?></a></td>
           <td class="row-data1"><?php echo $result['Road No.'] ?></td>
           <td class="row-data1"> <?php echo $result['Thana'] ?></td>
           <td class="row-data1"> <?php echo $result['District'] ?></td>
           <td class="row-data1"> <?php echo $result['Phone No.']?></td>
