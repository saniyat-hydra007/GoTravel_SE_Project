...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
    if(
        ...
        try{
           ...
           // $enc_password = md5($pass);
            ...
            $myquery="SELECT * FROM car_owners WHERE login_id = '$username' and password ='$pass'";
            ...
            if($returnobj->rowCount() == 1){
                ...
                $_SESSION['access'] = 'cae_owner';
              //  $_SESSION['role'] = $role;   //after session starts
                ?>
                <script>window.location.assign("car_owner_home.php");</script>
                <?php
            }
            else {
            ?>
                <script>alert("Wrong username and password.");</script>
                <script>window.location.assign("car_owner_login.php");</script>
            <?php
            }
    ...
    else
    {
        ...
        <script>location.assign("car_owner_login.php");</script>
    <?php
    }
