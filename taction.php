    ...
    <div class="page">
        ...
        <div id="m">
            ...
            <content id="text">
                <div id="n">
                    ...
                    $sql =  "SELECT id,availability FROM train_seat WHERE ticket_type like '$ticket_type'and 
                             Date = '$journey_date' and class like '$class' and l_id=$l_id and availability like 'y'";
                    ...
                    $sql1 = "SELECT * FROM train_seat where availability= 'y' and l_id=$l_id ";
                    ...
                    $sql2 = "UPDATE `train` SET `available_st`=$c where l_id=$l_id ";
        ...
        <script>
            ...
            function show2() {
                ...
                fetch('http://localhost/site/tapi2.php?seat=' + seat)
            ...
            payment.addEventListener('click', () => {
                ...
                location.assign('taddlist.php?l_id='+l_id+'&j_date='+j_date+'&fare='+fare+'&ticket_cancellation_fee='+ticket_cancellation_fee+'&slocation='+slocation+'&elocation='+elocation+'&base='+base+'&dest='+dest);
            });
