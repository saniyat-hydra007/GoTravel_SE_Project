...
INSERT INTO `train_seat` (`n`, `ticket_type`, `class`, `availability`, `id`, `Date`, `l_id`, `userr`, `pay`, `pass`) VALUES
('padma xpress', 'refundable', 'chair', 'y', 1, '2021-09-25', 1, 'NULL', 'no', 0),
('padma xpress', 'refundable', 'chair', 'y', 2, '2021-09-25', 1, 'NULL', 'no', 0),
('padma xpress', 'refundable', 'chair', 'y', 3, '2021-09-25', 1, 'NULL', 'no', 0),
