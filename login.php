...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    ...
    <div class="page">
      ...
      <form id="box2" action="loginprocess.php" method="POST">
        ...
        <br>
        <input class="button button-md button-default-outline-2 button-ujarak" type="submit" value="Click to Login">

      </form>

      <form id="box2" action="register.php" method="POST">
        <div style="font-size: 20px;margin: 10px;"><b> Don't have an account yet? Register Now!</b> </div>

        <button class="button button-md button-default-outline-2 button-ujarak" type="submit">Register</button>

        <br>
      </form>

      <form id="box2" action="register.php" method="POST">
        <div style="font-size: 20px;margin: 10px;"><b> Other Login</b> </div>

        <button class="button button-md button-default-outline-2 button-ujarak" type="button" onclick="a_login()">Log In as Admin</button>
        <br>
        <button class="button button-md button-default-outline-2 button-ujarak" type="button" onclick="car_owner_login()">Log In as Car Owner</button>
        <br>
        <button class="button button-md button-default-outline-2 button-ujarak" type="button" onclick="g_login()">Log In as Guide</button>
        <br>
      </form>
    ...
    <script>
        ...
        function car_owner_login(){
            location.assign('car_owner_login.php');
        }
        function g_login(){
            location.assign('a_login.php');
        }
