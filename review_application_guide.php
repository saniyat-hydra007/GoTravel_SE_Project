...
<div id="box3">
  <div>
    <label for="selectType" class="text1">Select:</label>
  </div>
  <div id="filter_dropdown">
      <select class="text" id="application_type" name="application_type" onchange="selectType()">
        <option selected="selected" value="guide">Guide</option>;
...
<div id="application_list_table">  </div>
...
<!--------------------------------------------------------------------------------------------------------------------------------------->
    ...
    function approveOwner(owner_id){
      location.assign('set_car_owner_login_data.php?owner_id='+owner_id);
    }
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        $("#application_list_table").load("guide_application_api.php");
        $("#application_type").change(function(){
          ...
          else if(selected == "car_owner"){
            $("#application_list_table").load("car_owner_application_api.php");
          }
        });
