...
<body>
    ...
    <div class="page">
        ...
        $sql =  "SELECT id,ticket_type,n,Date,class FROM train_seat WHERE Date = '$j_date' and l_id=$l_id and userr='sooha' and pass=123 and pay='no' ";
        ...
        <script>
            final.addEventListener('click', () => {
                ...
                if (res != 0) {
                    ...
                    if (count == 0){
                        fetch('http://localhost/site/tapi3.php?l_id=' + l_id)
            ...
            function remove() {
                ...
                fetch('http://localhost/site/tapi.php?seat=' + seat)
                    .then(response => response.json())
                    .then(json => {
